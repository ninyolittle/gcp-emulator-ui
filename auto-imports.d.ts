...
declare global {
  ...
  const SERVICE_NAMES: typeof import('./src/composables/useServiceConnections').SERVICE_NAMES
  ...
  const useApiConnection: typeof import('./src/composables/useApiConnection').useApiConnection
  ...
  const useDatastoreImportExport: typeof import('./src/composables/useDatastoreImportExport').useDatastoreImportExport
  ...
  const useTopicsStore: typeof import('./src/stores/topics').useTopicsStore
...
declare global {
  ...
  // @ts-ignore
  export type { ServiceName, ServiceConnectionStatus, ConnectionStatus, ConnectionState } from './src/composables/useServiceConnections'
