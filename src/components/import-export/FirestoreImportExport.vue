  ...
  <div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg theme-transition-colors">
      <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 theme-transition-colors">
        ...
        <p class="mt-1 text-xs sm:text-sm text-gray-600 dark:text-gray-400">
          Export all collections and documents to JSON files
        </p>
      </div>
      <div class="p-6">
        <div class="space-y-4">
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg theme-transition-colors">
      <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 theme-transition-colors">
        ...
        <p class="mt-1 text-xs sm:text-sm text-gray-600 dark:text-gray-400">
          Import collections and documents from JSON files
        </p>
      </div>
      <div class="p-6">
        <div class="space-y-6">
...
import { useFirestoreImportExport } from '@/composables/useFirestoreImportExport'
